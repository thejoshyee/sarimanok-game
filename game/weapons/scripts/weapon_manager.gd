...
func _ready() -> void:
	...
	weapon_scenes["spiral_feathers"] = preload("res://weapons/scenes/spiral_feathers_weapon.tscn")
	weapon_scenes["ice_shard"] = preload("res://weapons/scenes/feather_shot_weapon.tscn") # feather shot clone with slow debuff
